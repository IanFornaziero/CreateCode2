...
public class TargetX : MonoBehaviour
{
    ...
    private void OnMouseDown() //estava como mouse enter, ou seja, quando entrasse na área iria destruir, mas o intuito é clicar para destruir, então é necessário alterar
    {
